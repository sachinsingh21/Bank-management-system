...
public class AccountHolderSceneController implements Initializable {
    ...
    private void addCustomer(ActionEvent event) {
         ...
         Connection c;
          ...
          if(!update){
            ...
            accountNumber = branch+"10001";
                ...
                if(rs.next()){
                    ...
                    accountNumber = branch+id;
                     ...
                     accountNumber = branch+"0001";
                     }
           
            }
                   
            
            String query = "INSERT INTO accounttable (Account_Number,PIN,Account_Type,BCode,Name,Gender,Dob,Address,Aadhar,Balance)VALUES("+
           ...
           String query = "Update accounttable set PIN='"+pin+"',Account_Type='"+type+"',BCode='"+branch+"',Name='"+name+"',"
 ...
 String query="Select Id,Account_Number,Account_Type,BCode,Name,Aadhar,Balance from accountTable;";
    @FXML
    private void srcAcntNum(ActionEvent event) {
        
        String acc = accnum.getText();
        if(acc!=null && !acc.isEmpty()){
        query = "Select Id,Account_Number,Account_Type,BCode,Name,Aadhar,Balance from accountTable where Account_Number='"+acc+"';";
        
        }else{
        query = "Select Id,Account_Number,Account_Type,BCode,Name,Aadhar,Balance from accountTable;";
